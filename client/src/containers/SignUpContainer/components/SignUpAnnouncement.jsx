    ...
    return (
        <SignUpAnnouncementWrapper>
            <AnnouncementTitle>Регистрация</AnnouncementTitle>
				...
				<Alert color="success">
					<b>Внимание!</b> При вводе имени и пароля допустимо использовать только символы латинского алфавита <Badge color="success">a-z</Badge>,
					символы <Badge color="success">- _</Badge>  и цифры <Badge color="success">0-9</Badge>
				</Alert>
